  ...
  return (
    <Container>
      <BGImage>
        <Navbar />
        <Content>
          <Heading>REAL ESTATE AGENCY</Heading>
          <SearchBar>
          ...
          <Subinfo>
            <Info>Find Property at low prices</Info>
      ...
      <CTA>
        <CTAHeading>Get the best Results for Investment Property Services</CTAHeading>
        <CTASubHeading>
        Find what you are looking for! 99% Match on Investment Property Services. Find Here - Free, Private and Secure. 
        </CTASubHeading>
        <CTAButton>Invest</CTAButton>
      </CTA>
